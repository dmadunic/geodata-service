...
import com.ag04.geodata.rest.repository.CountryRepository;
import com.ag04.geodata.rest.service.CountryService;
import com.ag04.geodata.rest.service.dto.CountryDTO;
import com.ag04.geodata.rest.service.mapper.CountryMapper;
import com.ag04.geodata.rest.service.dto.CountryCriteria;
import com.ag04.geodata.rest.service.CountryQueryService;
...
public class CountryResourceIT {
    ...
    @Test
    @Transactional
    public void getAllCountriesByCodeA2IsEqualToSomething() throws Exception {
        // Initialize the database
        countryRepository.saveAndFlush(country);
    ...
    @Test
    @Transactional
    public void getAllCountriesByCodeA2IsNotEqualToSomething() throws Exception {
        // Initialize the database
        countryRepository.saveAndFlush(country);
    ...
    @Test
    @Transactional
    public void getAllCountriesByCodeA2IsInShouldWork() throws Exception {
        // Initialize the database
        countryRepository.saveAndFlush(country);
    ...
    @Test
    @Transactional
    public void getAllCountriesByCodeA2IsNullOrNotNull() throws Exception {
        // Initialize the database
        countryRepository.saveAndFlush(country);
        ...
        defaultCountryShouldNotBeFound("codeA2.specified=false");
                ...
                @Test
    @Transactional
    public void getAllCountriesByCodeA2ContainsSomething() throws Exception {
        // Initialize the database
        countryRepository.saveAndFlush(country);
    ...
    @Test
    @Transactional
    public void getAllCountriesByCodeA2NotContainsSomething() throws Exception {
        // Initialize the database
        countryRepository.saveAndFlush(country);
    ...
    @Test
    @Transactional
    public void getAllCountriesByCodeA3IsEqualToSomething() throws Exception {
        // Initialize the database
        countryRepository.saveAndFlush(country);
    ...
    @Test
    @Transactional
    public void getAllCountriesByCodeA3IsNotEqualToSomething() throws Exception {
        // Initialize the database
        countryRepository.saveAndFlush(country);
    ...
    @Test
    @Transactional
    public void getAllCountriesByCodeA3IsInShouldWork() throws Exception {
        // Initialize the database
        countryRepository.saveAndFlush(country);
    ...
    @Test
    @Transactional
    public void getAllCountriesByCodeA3IsNullOrNotNull() throws Exception {
        // Initialize the database
        countryRepository.saveAndFlush(country);
        ...
        defaultCountryShouldNotBeFound("codeA3.specified=false");
                ...
                @Test
    @Transactional
    public void getAllCountriesByCodeA3ContainsSomething() throws Exception {
        // Initialize the database
        countryRepository.saveAndFlush(country);
    ...
    @Test
    @Transactional
    public void getAllCountriesByCodeA3NotContainsSomething() throws Exception {
        // Initialize the database
        countryRepository.saveAndFlush(country);
    ...
    @Test
    @Transactional
    public void getAllCountriesByFlagIsEqualToSomething() throws Exception {
        // Initialize the database
        countryRepository.saveAndFlush(country);
    ...
    @Test
    @Transactional
    public void getAllCountriesByFlagIsNotEqualToSomething() throws Exception {
        // Initialize the database
        countryRepository.saveAndFlush(country);
    ...
    @Test
    @Transactional
    public void getAllCountriesByFlagIsInShouldWork() throws Exception {
        // Initialize the database
        countryRepository.saveAndFlush(country);
    ...
    @Test
    @Transactional
    public void getAllCountriesByFlagIsNullOrNotNull() throws Exception {
        // Initialize the database
        countryRepository.saveAndFlush(country);
        ...
        defaultCountryShouldNotBeFound("flag.specified=false");
                ...
                @Test
    @Transactional
    public void getAllCountriesByFlagContainsSomething() throws Exception {
        // Initialize the database
        countryRepository.saveAndFlush(country);
    ...
    @Test
    @Transactional
    public void getAllCountriesByFlagNotContainsSomething() throws Exception {
        // Initialize the database
        countryRepository.saveAndFlush(country);
    ...
    @Test
    @Transactional
    public void getAllCountriesByActiveIsEqualToSomething() throws Exception {
        // Initialize the database
        countryRepository.saveAndFlush(country);
    ...
    @Test
    @Transactional
    public void getAllCountriesByActiveIsNotEqualToSomething() throws Exception {
        // Initialize the database
        countryRepository.saveAndFlush(country);
    ...
    @Test
    @Transactional
    public void getAllCountriesByActiveIsInShouldWork() throws Exception {
        // Initialize the database
        countryRepository.saveAndFlush(country);
    ...
    @Test
    @Transactional
    public void getAllCountriesByActiveIsNullOrNotNull() throws Exception {
        // Initialize the database
        countryRepository.saveAndFlush(country);
